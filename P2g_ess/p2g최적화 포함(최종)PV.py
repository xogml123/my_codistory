...
num_pv=[j for j in range(num_pv_init-400*5,num_pv_init+400*5,400)]#10
num_wt=[k for k in range(0,num_wt_init+2*10,2)]#10
...
if smallest_case_variate[2]-1<=0:
    num_wt2=[l for l in range(0,smallest_case_variate+2)]
else:
