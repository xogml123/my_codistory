...
num_pv=[j for j in range(num_pv_init-200*5,num_pv_init+200*5,200)]#10
num_wt=[k for k in range(num_wt_init-2*5,num_wt_init+2*5,2)]#10
...
num_pv2=[j for j in range(smallest_case_variate[1]-20*5,smallest_case_variate[1]+20*5,20)]#10
...
smallest_case2=1000000000000000000
smallest_case_variate2=[]
for i in result2:
    
    cost=i[0]*ess_cost_per_W+i[1]*pv_cost_per_unit+i[2]*wt_cost_per_unit+i[3]*p2g_cost_per_W+i[5]*fuel_cell_cost_per_W
    if cost <smallest_case2:
        smallest_case2=cost
        smallest_case_variate2=i.copy()
    
print('ess=',smallest_case_variate2[0])
print('pv=',smallest_case_variate2[1])
print('wt=',smallest_case_variate2[2])
print('p2g=',smallest_case_variate2[3])
print('잉여생산량=',smallest_case_variate2[4])
print('fuelcell=',smallest_case_variate2[5])
